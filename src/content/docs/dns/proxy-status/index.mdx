...
description: Learn how Cloudflare's proxy status affects DNS records and optimizes traffic. Enable proxy for A, AAAA, and CNAME records to enhance security and performance.
