...
sidebar:
  order: 2
description: Learn how Cloudflare Access uses application tokens for secure identity-based authentication. Understand JWT structure, validation, and integration.
---
