...
sidebar:
  order: 4
head: []
description: Understand how Cloudflare prioritizes certificates and hostnames, including deployment, presentation, and example scenarios for SSL/TLS settings.
